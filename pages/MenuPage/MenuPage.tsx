...
export default function MenuPage() {
    return (
        <Box h={'100vh'} style={{ background: `linear-gradient(190deg, #8DC1D0 30%, rgba(0, 0, 0, 0)30%)` }}>
            ...
            <NavBar></NavBar>
            <Box p={4}>
                <Tabs pl={'0.5em'} pt={'2em'} variant='soft-rounded' colorScheme={'teal'}>
                    <TabList justifyContent={'space-around'}>
                        <Tab fontSize={14} color={'white'}>Coffee</Tab>
                        <Tab fontSize={14}  color={'white'}>Tea</Tab>
                        <Tab fontSize={14}  color={'white'}>Cold Drink</Tab>
                        <Tab fontSize={14}  color={'white'}>Dessert</Tab>
                    </TabList>
                    <TabPanels>
                        <TabPanel>
                            <HStack pt={'2vh'}>
