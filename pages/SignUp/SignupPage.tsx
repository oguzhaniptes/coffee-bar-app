    ...
    return (
            <Box >
                <Box bgImage="/signUp-background.svg" w={"100vw"} h={"100vh"} backgroundColor={"#fefdf9"} bgPosition={"center"} bgRepeat={'no-repeat'}>
                    <Link href={"/WelcomePage/WelcomePage"}>
                        <IconButton aria-label='' ml={6} mt={6} variant={'unstyled'} icon={<ChevronLeftIcon boxSize={8} color={'white'}></ChevronLeftIcon>}></IconButton>
                    </Link>
                    <Box>
                        ...
                        <Box  w={'80vw'}>
                            <HStack  justifyContent={"space-between"} >
                                ...
                                <Link href='/HomePage/HomePage'>
                                    <IconButton aria-label='' boxSize={'90'} borderRadius={'100'} background={'#3f434c'} variant={'unstyled'} icon={<ArrowForwardIcon color={'white'} boxSize={8} ></ArrowForwardIcon>} _hover={{ background: "#515764" }}></IconButton>
                                </Link>
                            </HStack>
                        </Box>
                        <HStack w="80vw" >
                            <Text color={'white'} fontWeight={'bold'} as={'u'}><Link href='/SignIn/SigninPage'>Sign in</Link></Text>
                        </HStack>
                    </VStack>
                </Box>
            </Box>
